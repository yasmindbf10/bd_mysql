...
-- -----------------------------------------------------
-- Table `my_blog`.`tb_temas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `my_blog`.`tb_temas` (
...
-- -----------------------------------------------------
-- Table `my_blog`.`tb_usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `my_blog`.`tb_usuarios` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `my_blog`.`tb_postagens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `my_blog`.`tb_postagens` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
